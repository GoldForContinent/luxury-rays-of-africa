...
const briefItinerary = [
  { day: "1", place: "Nairobi – Samburu", highlights: "Fly to Samburu, afternoon game drive", property: "Soroi Larsens Camp" },
  { day: "2", place: "Samburu Game Reserve", highlights: "Full day game drive experience", property: "Soroi Larsens Camp" },
  { day: "3", place: "Samburu – Fly to Masai Mara", highlights: "Fly to Mara, afternoon game drive", property: "Soroi Luxury Migration Camp" },
  { day: "4", place: "Masai Mara – Departure", highlights: "Morning game drive, fly to Nairobi", property: "N/A" }
]
...
const itineraryDays = [
  ...
  {
    day: 2,
    title: "The Game Drive Experience - Samburu",
    highlights: ["Full day game drives", "Samburu Special 5", "Northern endemic species"],
    description: "Awaken to the serene wilderness of Samburu. A full day of exploration awaits, with morning and afternoon game drives across the rugged landscapes, unveiling the diverse wildlife unique to this region. Samburu National Reserve is renowned for its unique 'Samburu Special 5' species, endemic to Northern Kenya. These include the rare Grevy's Zebra, Somali Ostrich, Beisa Oryx, Gerenuk, and the beautiful reticulated giraffes.",
    accommodation: "Soroi Larsens Camp",
    mealPlan: "Full Board",
  ...
  },
  {
    ...
    highlights: ["Fly to Masai Mara", "Afternoon game drive", "Big Five sightings"],
    description: "Bid farewell to Samburu as you take a scheduled light aircraft transfer to the Maasai Mara, landing in the embrace of the Soroi Luxury Migration Camp. The late afternoon promises an enchanting game drive in the heart of the Mara as the sun casts golden hues across the plains. Discover the Big Five and, if the season allows, witness the awe-inspiring spectacle of the Great Migration (July to October).",
  ...
  {
    day: 4,
    title: "Masai Mara – Departure to Nairobi",
    highlights: ["Morning game drive", "Fly to Nairobi", "Transfer to airport"],
    description: "A new day dawns in the Maasai Mara, beckoning you to explore its vast expanses on game drives. Our custom-built 4×4 safari vehicles are stationed at the camp and can be booked during your stay for exclusive use, with an experienced professional Safari guide. All our guides are certified by the Kenya Professional Guides Association. As the sun rises on your final day, soak in the wilderness one last time before your scheduled light aircraft transfer back to Wilson Airport in Nairobi.",
    accommodation: "N/A",
    mealPlan: "Breakfast",
...
const pricingData = [
  { period: "Shoulder Season: 04-Jan-2026 to 28-Feb-2026 & 1 Jun-26 to 30-Jun-26", price: "$5,465", supplement: "$1,455" },
  { period: "Low Season: 01-Mar-2026 to 31-May-2026", price: "$5,105", supplement: "$1,275" },
  { period: "Peak Season: 01-Jul-2026 to 30-Sep-2026", price: "$6,110", supplement: "$1,645" },
  { period: "Shoulder Season: 01-Oct-2026 to 19-Dec-2026", price: "$5,370", supplement: "$1,275" },
]
...
const extraAddons = [
  ...
  "Private game drive vehicle with dedicated guide",
...
export default function KenyaWingsOverWilderness4Days() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0]">
      ...
      <section ref={heroRef} className="relative h-[70vh] overflow-hidden">
        <img 
          src="https://images.pexels.com/photos/2251164/pexels-photo-2251164.jpeg?auto=compress&cs=tinysrgb&w=1600" 
          alt="Wings Over the Wilderness Safari - 4 Days" 
        ...
        <div className="hero-content absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="text-xl md:text-2xl text-white/90 mb-2">4 Days / 3 Nights</div>
          <div className="flex items-center gap-4 text-white/80 mb-8">
            <span className="flex items-center gap-2"><Clock size={18} /> 4 Days</span>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-3xl md:text-5xl text-[#2C3E50] mb-6">
              A Quick Escape Into Kenya's Wild Heart
            </h2>
            <p className="text-[#2C3E50] text-lg leading-relaxed max-w-4xl mx-auto">
              Embark on a captivating journey through Kenya's wilderness with our 4 Nights Wings over the Wilderness Safari. This meticulously crafted adventure whisks you away from the bustling streets of Nairobi, offering a serene escape into the heart of Kenya's pristine wilderness. From the rugged terrains of Samburu to the expansive plains of the Maasai Mara, every day unveils a new chapter of adventure and discovery. With the sky as your pathway, traverse the wild landscapes in a scheduled light aircraft, descending into a world where nature choreographs the rhythm of life.
            </p>
          </div>

          <div className="grid md:grid-cols-4 gap-6">
            {[
              { Icon: Plane, title: "Fly-In Safari", desc: "Seamless air transfers" },
              { Icon: LandPlot, title: "Big Five", desc: "Lion, Leopard, Elephant, Rhino, Buffalo" },
              { Icon: Sun, title: "Great Migration", desc: "Witness the wildebeest (Jul-Oct)" },
              { Icon: Trees, title: "Samburu Special 5", desc: "Unique Northern species" }
            ].map((item, index) => (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-xl mb-8">
            <div className="grid grid-cols-3 bg-[#D4A03A] text-black font-bold p-4">
              ...
              <div className="text-right">Single Supplement</div>
            </div>
            {pricingData.map((price, index) => (
              <div key={index} className="grid grid-cols-3 p-4 border-b border-[#D4C5B9] hover:bg-[#FAF3E0]">
                ...
                <div className="text-right text-[#2C3E50]/70">US$ {price.supplement}</div>
              </div>
            ))}
          </div>
