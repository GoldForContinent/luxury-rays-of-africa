...
import { MapPin, Clock, Check, X, Star, Camera, Baby, Castle, Smile } from 'lucide-react'

gsap.registerPlugin(ScrollTrigger)

const briefItinerary = [
  { day: "1", place: "Nairobi – Giraffe Manor", highlights: "Giraffe feeding, evening nature walk", property: "Giraffe Manor" },
  { day: "2", place: "Nairobi – Amboseli", highlights: "Drive to Amboseli, afternoon drive", property: "Amboseli Lodge" },
  { day: "3", place: "Amboseli – Full Day", highlights: "Elephants with Mt. Kilimanjaro", property: "Amboseli Lodge" },
  { day: "4", place: "Amboseli – Lake Nakuru", highlights: "Drive to Nakuru, flamingos", property: "Nakuru Lodge" },
  { day: "5", place: "Lake Nakuru – Day 2", highlights: "Rhinos, birdlife, family activities", property: "Nakuru Lodge" },
  { day: "6", place: "Nakuru – Masai Mara", highlights: "Drive to Mara, evening drive", property: "Mara Camp" },
  { day: "7", place: "Masai Mara – Full Day", highlights: "Big Five, family game drives", property: "Mara Camp" },
  { day: "8", place: "Masai Mara – Day 2", highlights: "Optional balloon safari, cultural visit", property: "Mara Camp" },
  { day: "9", place: "Masai Mara – Day 3", highlights: "Morning drive, pool time", property: "Mara Camp" },
  { day: "10", place: "Masai Mara – Lake Naivasha", highlights: "Drive to Naivasha, boat ride", property: "Naivasha Camp" },
  { day: "11", place: "Lake Naivasha – Day 2", highlights: "Crescent Island walk, hippos", property: "Naivasha Camp" },
  { day: "12", place: "Naivasha – Nairobi", highlights: "Final drive, city tour", property: "Nairobi Hotel" },
  { day: "13", place: "Nairobi – Full Day", highlights: "Elephant orphanage, museum", property: "Nairobi Hotel" },
...
const itineraryDays = [
  {
    day: 1,
    title: "Nairobi Arrival · Giraffe Manor",
    highlights: ["Giraffe feeding", "Nature walk", "Manor experience"],
    description: "Arrive in Nairobi and transfer to the iconic Giraffe Manor. This historic boutique hotel is famous for its resident giraffes who wander the grounds. Spend the afternoon feeding giraffes from the breakfast table — a magical experience for the whole family. Evening nature walk in the sanctuary.",
  ...
  },
  {
    ...
    description: "Depart Nairobi early morning for Amboseli National Park, approximately a four-hour drive through the Rift Valley. Amboseli is known for its large elephant herds and spectacular views of Mount Kilimanjaro. Arrive at your lodge by lunch. Afternoon game drive.",
  ...
  },
  {
    ...
    description: "Full day in Amboseli — perfect for families. Morning game drive as elephants emerge from the swamps against the backdrop of snow-capped Kilimanjaro. Watch for lions, cheetahs, and buffaloes. Children love watching elephant families interact. Afternoon game drive and swamp visit.",
    accommodation: "Amboseli Lodge",
    mealPlan: "Full Board",
  ...
  },
  {
    ...
    highlights: ["Final morning", "City tour", "Hotel check-in"],
    description: "Early morning at the lake — watch the hippos as they return to the water after grazing. Breakfast at camp, then depart for Nairobi. Afternoon city tour — visit the Elephant Orphanage, Giraffe Center, or Karen Blixen Museum. Evening at your hotel.",
  ...
  {
    day: 13,
    title: "Nairobi · Full Day Exploration",
    highlights: ["Elephant orphanage", "Museum visit", "Shopping"],
    description: "Full day exploring Nairobi. Morning visit to the David Sheldrick Wildlife Trust Elephant Orphanage — a heartwarming experience for children. Afternoon visit to the Nairobi National Museum or Giraffe Center. Evening optional shopping at the Maasai Market.",
    accommodation: "Nairobi Hotel",
  ...
  },
  {
    ...
    highlights: ["Final breakfast", "Airport transfer", "Safari concludes"],
    description: "Morning at leisure. Transfer to Jomo Kenyatta International Airport for your departure flight. Your safari concludes here with memories that will last a lifetime.",
    accommodation: "N/A",
    mealPlan: "Breakfast",
    image: "https://images.pexels.com/photos/4614229/pexels-photo-4614229.jpeg?auto=compress&cs=tinysrgb&w=800"
  }
...
const pricingData = [
  { period: "Green Season: Apr - Jun 2026", price: "$4,870", supplement: "$680" },
  { period: "High Season: Jul - Mar 2026/27", price: "$5,270", supplement: "$780" },
  { period: "Peak Season: Jul - Oct 2026", price: "$5,870", supplement: "$920" }
]
...
const extraAddons = [
  ...
  "Extra nights in Nairobi"
]

export default function KenyaUltimateFamilySafariKenya() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0]">
      <section ref={heroRef} className="relative h-[70vh] overflow-hidden">
        <img src="https://images.pexels.com/photos/2580639/pexels-photo-2580639.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="Ultimate Family Safari Kenya" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="absolute top-24 left-1/2 -translate-x-1/2 text-white/80 text-sm">
          ...
          <span className="text-[#D4A03A]">Ultimate Family Safari</span>
        </div>
        <div className="hero-content absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <div className="text-[#D4A03A] font-medium tracking-[0.3em] text-sm mb-4">ULTIMATE FAMILY SAFARI</div>
          <h1 className="font-display font-black text-4xl md:text-6xl lg:text-7xl text-white mb-4 tracking-tight">Ultimate Family Safari Kenya</h1>
          <div className="text-xl md:text-2xl text-white/90 mb-2">14 Days of Magic for the Whole Family</div>
          <div className="flex items-center gap-4 text-white/80 mb-8"><span className="flex items-center gap-2"><Clock size={18} /> 14 Days</span><span className="flex items-center gap-2"><MapPin size={18} /> 6 Destinations</span></div>
          <div className="text-3xl md:text-4xl font-bold text-[#D4A03A]">From USD $ 5,270 Per Person</div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 md:px-[8vw] bg-[#FFF8F0]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-3xl md:text-5xl text-[#2C3E50] mb-6">The Safari of a Lifetime for Families</h2>
            <p className="text-[#2C3E50] text-lg leading-relaxed max-w-4xl mx-auto">This 14-day ultimate family safari is designed to give your family the complete Kenya experience. From feeding giraffes in Nairobi to walking with elephants in Amboseli and watching hippos in Lake Naivasha, every day brings new adventures and magical moments.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {[{Icon: Castle, title: "Giraffe Manor", desc: "Start at iconic manor"}, {Icon: Baby, title: "Family Friendly", desc: "Safe & exciting for kids"}, {Icon: Smile, title: "Unique Activities", desc: "Walking, boating, villages"}, {Icon: Camera, title: "Wildlife", desc: "Big Five & more"}].map((item, index) => (
      ...
      <section ref={addToRefs} className="py-16 px-4 md:px-[8vw] bg-[#FFF8F0]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-xl"><p className="text-yellow-800 text-sm"><strong>Note:</strong> Deposit to reserve: $450. Balance due: 21 days prior. Children pricing available. Family rooms available.</p></div>
        </div>
      </section>
      ...
      <section ref={addToRefs} className="py-20 px-4 md:px-[8vw] bg-[#2B1E1A]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display font-bold text-3xl md:text-5xl text-[#F7F2EA] mb-6">Create Unforgettable Family Memories</h2>
          <p className="text-lg text-[#F7F2EA]/70 mb-8">Give your family the gift of a lifetime — 14 days of adventure in Kenya.</p>
