...
import { MapPin, Clock, Check, X, Star, LandPlot, Camera, Sun, Mountain } from 'lucide-react'
...
const briefItinerary = [
  ...
  { day: "3", place: "Masai Mara – Day 2", highlights: "Morning safari, optional activities", property: "Mara Camp" },
  { day: "4", place: "Masai Mara – Nairobi", highlights: "Morning game drive, return to Nairobi", property: "N/A" }
]
...
const itineraryDays = [
  ...
  },
  {
    ...
    highlights: ["Morning game drive", "Optional balloon safari", "Evening sundowners"],
    description: "Another full day to explore this extraordinary reserve. Morning game drive searches for wildlife missed the previous day — perhaps leopard in a tree, cheetah on the hunt, or a rhino. Optional activities include a hot air balloon safari over the plains (additional cost). Afternoon at leisure or additional game drive. Evening — sundowners on the plains with views of the African sunset.",
    accommodation: "Mara Camp",
    mealPlan: "Full Board",
  ...
  },
  {
    ...
    highlights: ["Final morning drive", "Return journey", "Arrival in Nairobi"],
    description: "Early morning game drive captures the Mara at its most active — predators on the hunt, herbivores grazing, the savanna coming alive with the dawn. Return to camp for breakfast, then depart for Nairobi. The return journey takes approximately five hours. Arrive in Nairobi by late afternoon.",
    accommodation: "N/A",
    mealPlan: "Breakfast",
...
const includes = [
  "All accommodation — classic tented camp",
...
export default function KenyaMagicalMaasaiMara() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0]">
      <section ref={heroRef} className="relative h-[70vh] overflow-hidden">
        <img src="https://images.pexels.com/photos/2374659/pexels-photo-2374659.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="Magical Maasai Mara" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="absolute top-24 left-1/2 -translate-x-1/2 text-white/80 text-sm">
          ...
          <span className="text-[#D4A03A]">Magical Maasai Mara</span>
        </div>
        <div className="hero-content absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <div className="text-[#D4A03A] font-medium tracking-[0.3em] text-sm mb-4">ICONIC SAFARI</div>
      ...
      <section className="py-16 px-4 md:px-[8vw] bg-[#FFF8F0]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-3xl md:text-5xl text-[#2C3E50] mb-6">Kenya's Crown Jewel</h2>
            <p className="text-[#2C3E50] text-lg leading-relaxed max-w-4xl mx-auto">The Masai Mara is Kenya's most famous national reserve and one of Africa's greatest wildlife destinations. This four-day safari gives you ample time to explore the vast savanna, track the Big Five, and witness the incredible density of wildlife that makes the Mara legendary.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {[{Icon: Mountain, title: "Iconic", desc: "Africa's finest reserve"}, {Icon: LandPlot, title: "Big Five", desc: "All species present"}, {Icon: Sun, title: "4 Days", desc: "Extended exploration"}, {Icon: Camera, title: "Photography", desc: "Wildlife galore"}].map((item, index) => (
      ...
      <section ref={addToRefs} className="py-20 px-4 md:px-[8vw] bg-[#2B1E1A]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display font-bold text-3xl md:text-5xl text-[#F7F2EA] mb-6">Experience the Magic</h2>
          <p className="text-lg text-[#F7F2EA]/70 mb-8">The Masai Mara awaits with unforgettable wildlife encounters.</p>
