...
const activities = [
  {
    ...
    description: 'Calm waters with coral reefs perfect for swimming and snorkeling adventures.'
  },
  {
    icon: Anchor,
    title: 'Deep Sea Fishing',
    description: ' Charter boats available for marlin, tuna, and other big game fishing.'
  },
  {
    icon: Car,
    title: 'Dhow Excursions',
    description: 'Traditional sailing dhow trips along the coast and to nearby islands.'
  },
  {
    icon: Palmtree,
    title: 'Shimba Hills Safari',
    description: 'Day trips to Shimba Hills National Reserve for elephant and sable antelope.'
  }
]

const seasonalData = [
  { season: 'Low Season', months: 'April - May, November', description: 'Lush green landscapes, fewer crowds, lower rates. Some rain expected.' },
  { season: 'High Season', months: 'June - September, January - February', description: 'Perfect weather, calm seas, excellent for water activities. Great visibility for snorkeling.' },
  { season: 'Peak Season', months: 'July - August, December', description: 'Peak tourist season with optimal beach conditions. Highest prices and advance booking recommended.' }
]

export default function DianiBeach() {
    ...
    <div className="min-h-screen bg-[#FFF8F0]">
      ...
      <section ref={heroRef} className="relative h-[85vh] overflow-hidden">
        ...
        <div className="hero-content absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-[#D4A03A] text-lg md:text-xl uppercase tracking-[0.3em] mb-8">
            Kenya's Premier Coastal Destination
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-[#2C3E50] text-lg leading-relaxed mb-6">
                Diani Beach is Kenya's most beloved coastal destination, stretching along the Indian Ocean on the country's south coast. Located approximately 30 kilometers south of Mombasa, this paradise offers a perfect blend of natural beauty, adventure, and relaxation.
              </p>
              <p className="text-[#2C3E50] text-lg leading-relaxed mb-6">
                The beach boasts pristine white sands, crystal-clear turquoise waters, and a stunning coral reef system just offshore. Whether you're seeking thrilling water sports, peaceful sunbathing, or cultural experiences, Diani delivers an unforgettable Kenyan coast adventure.
              </p>
              <p className="text-[#2C3E50] text-lg leading-relaxed">
                Beyond the beach, the nearby Shimba Hills National Reserve offers wildlife encounters, while the local Swahili communities provide rich cultural experiences. With excellent resort options, world-class restaurants, and a vibrant atmosphere, Diani Beach remains East Africa's most sought-after beach destination.
              </p>
            </div>
            <div className="relative">
              <div className="absolute -inset-4 bg-[#D4A03A]/20 rounded-2xl transform rotate-3"></div>
              <img src="/diani2.jpg" alt="Diani Beach Sunset" className="relative rounded-2xl shadow-2xl w-full h-96 object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-[#2C3E50]/70">
                Fly into Ukunda Airstrip from Nairobi (45 minutes) or Mombasa. Daily domestic flights operate from Wilson Airport. From Ukunda, it's a short drive to your beach resort.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <div className="w-14 h-14 bg-[#D4A03A]/10 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-[#2C3E50]/70">
                Drive from Mombasa via the Likoni Ferry (approximately 1.5-2 hours). The scenic coastal road passes through picturesque fishing villages and coconut plantations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section ref={addContentRef} className="py-24 px-4 md:px-[8vw] bg-[#FFF8F0]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {dianiAccommodations.map((accommodation, index) => (
              <Link 
                key={index}
      ...
      <section ref={addContentRef} className="py-28 px-4 md:px-[8vw] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <h2 className="font-display font-bold text-4xl md:text-6xl text-white mb-4">
            READY FOR DIANI BEACH?
          </h2>
          <p className="text-[#D4A03A] text-lg uppercase tracking-widest mb-8">Let's Plan Your Coastal Adventure</p>
          <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto">
            Whether you want to combine Diani with a safari or enjoy a beach extension, we can create your perfect Kenyan coast experience.
          </p>
